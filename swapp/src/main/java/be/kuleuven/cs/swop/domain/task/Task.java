...
public class Task {
     ...
     * @param acceptableDeviation The acceptable deviation of time in which the task can be completed.
     */
     ...
     * @param description A String containing a possible description for this Task.
     ...
     * @param description The String containing the Task's new description.
     ...
     * @param estimatedDuration The double containing the possible new estimated duration for the Task in minutes.
     ...
     * @param estimatedDuration The double containing the new estimated duration in minutes.
     ...
     * @param deviation The double containing the deviation to be checked.
     ...
     * @param acceptableDeviation The double containing the new deviation.
     * @throws IllegalArgumentException If the given deviation is not valid.
     */
     ...
     * @param timespan The TimePeriod that has to be checked.
     ...
     * @param timespan The TimePeroid for when during the Task was performed.
     */
     ...
     * @param status The TaskStatus to be checked for validity.
     ...
     * @throws IllegalStateException If this Task can't finish with the current status.
     */
    public void finish() {
     ...
     * @throws IllegalStateException If this Task can't fail with the current status.
     */
    public void fail() {
