...
public class ScenarioTest {
    ...
    public void scenario1Test() throws ParseException {
        ...
        facade.createProject(projectData);

        Set<ProjectWrapper> projects = facade.getProjects();
        assertEquals(1, projects.size());

        ProjectWrapper project1 = null;
        ...
        // TODO dependencies
        facade.createTaskFor(project1, task1);
        assertEquals(1, facade.getTasksOf(project1).size());
        ...
        // TODO dependencies
        facade.createTaskFor(project1, task2);
        assertEquals(2, facade.getTasksOf(project1).size());
        ...
        // TODO dependencies
        facade.createTaskFor(project1, task3);
        assertEquals(3, facade.getTasksOf(project1).size());
        ...
        // TODO dependencies
        facade.createTaskFor(project1, task4);
        assertEquals(4, facade.getTasksOf(project1).size());
