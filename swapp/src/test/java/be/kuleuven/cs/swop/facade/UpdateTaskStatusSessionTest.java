...
public class UpdateTaskStatusSessionTest extends BaseFacadeTest {
    ...
    public void setUp() throws Exception {
        ...
        dev = taskMan.createDeveloper(new DeveloperData("John"));
    ...
    private void loginAsDev(){
        taskMan.requestAuthenticationFor(office, new UserWrapper(dev.getAsUser().getUser()));
    }
    ...
    public void ExecuteAndFinishTest() throws ConflictingPlannedTaskWrapperException {
        ...
        Set<Resource> resourceSet = new HashSet<Resource>(Arrays.asList(dev.getDeveloper()));
