...
**** Probleem: Verschillende soorten data nodig voor de statussen. Bv finished/failed hebben een time-period, terwijl de nieuwe executing een developer nodig heeft.
